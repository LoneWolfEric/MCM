y = xlsread('C:\Users\yuhui\Desktop\代码和论文\matlab\工作簿10.xlsx','d1:d50')
Data=y;              %共50个数据
...
hold on 
plot(Data,'b');
save('C:\Users\yuhui\Desktop\代码和论文\matlab\result\AZ总能源生产.mat')
...
hold on 
plot(Data,'b');
save('C:\Users\yuhui\Desktop\代码和论文\matlab\result\AZ可再生能源生产.mat')
...
y = xlsread('C:\Users\yuhui\Desktop\代码和论文\matlab\工作簿10.xlsx','v1:v50')
Data=y;              %共50个数据
SourceData=Data(1:50,1); %前250个训练集
step=41;                  %后50个测试
TempData=SourceData;
...
hold on 
plot(Data,'b');
save('C:\Users\yuhui\Desktop\代码和论文\matlab\result\AZ总能源消费.mat')
